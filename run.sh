...
# mpirun --mca btl_tcp_if_include eth0 -np 4 ./obj/main.out $POPULATION_SIZE $INITITAL_INFECTED $GRID_HEIGHT $GRID_WIDTH $TIME_STEP $MAX_SPEED $SPREAD_DISTANCE $SUSCEPTIBILITY_THR $INFECTION_THR $IMMUNITY_THR $COUNTRY_HEIGHT $COUNTRY_WIDTH $DAY $END_TIME $DENSITY_THR